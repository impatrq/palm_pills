...
#BYTE port_a = 0xF83                            //Dirección de puerto D en memoria.

int z=0;                                        //Variable x tipo entero, para el contador.
...
void main (void)                                //Funcion principal main
{
   ...
   set_tris_a(0b00000011);                      //Establecemos el Puerto D como salida.
